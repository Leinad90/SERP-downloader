...
class Container_06c850be32 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Logic\ProcessSerp' => [['02']],
		'App\Logic\ProcessDuckSerp' => [['02']],
		'GuzzleHttp\ClientInterface' => [['03']],
		'Psr\Http\Client\ClientInterface' => [['03']],
		'GuzzleHttp\Client' => [['03']],
	...
	public function createService02(): App\Logic\ProcessDuckSerp
	{
		return new App\Logic\ProcessDuckSerp(
	...
	public function createService03(): GuzzleHttp\Client
	{
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('/var/www/html/www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_06c850be32 $container,
			) {
			}
